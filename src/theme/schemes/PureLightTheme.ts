...
export const colors = {
  ...
  alpha: {
    ...
    yellow: {
      5: alpha(themeColors.yellow, 0.02),
      10: alpha(themeColors.yellow, 0.1),
      30: alpha(themeColors.yellow, 0.3),
      50: alpha(themeColors.yellow, 0.5),
      70: alpha(themeColors.yellow, 0.7),
      100: themeColors.yellow,
    },
    orange: {
      5: alpha(themeColors.orange, 0.02),
      10: alpha(themeColors.orange, 0.1),
      30: alpha(themeColors.orange, 0.3),
      50: alpha(themeColors.orange, 0.5),
      70: alpha(themeColors.orange, 0.7),
      100: themeColors.orange,
    }
  },
  secondary: {
  ...
  components: {
    ...
    MuiFab: {
      styleOverrides: {
          ...
          border: `1px solid ${colors.alpha.black[100]}`,
          "& .MuiSvgIcon-root": {
            color: colors.alpha.black[100]
          }
        }
